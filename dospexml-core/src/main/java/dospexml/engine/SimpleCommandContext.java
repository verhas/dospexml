...
import dospexml.api.Processor;
import dospexml.api.Query;
...
public class SimpleCommandContext implements CommandContext {
    final dospexml.engine.Processor processor;
    ...
    public SimpleCommandContext(dospexml.engine.Processor processor,
                                Node node,
